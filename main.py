...
def start():
    start_2 = time.time()
    query = """
1. Понятие, предмет, метод и задачи административно-деликтного
права.
2. Кодекс Республики Беларусь об административных
правонарушениях как источник административно-деликтного права, его
структура и содержание.
3. Задачи и принципы Кодекса Республики Беларусь об
административных правонарушениях.
4. Принципы действия КоАП в пространстве и по кругу лиц.
Действие КоАП во времени, правила обратной силы административно-
деликтного закона.
5. Понятие и признаки административного правонарушения.
6. Отличие административного правонарушения от преступления и
дисциплинарного проступка.
7. Категории административных правонарушений.
Множественность административных правонарушений.
    ...
    response = client.models.generate_content(
        ...
        config=types.GenerateContentConfig(
            ...
            Давай структурные ответы (не ставь лишние знаки).
            Если будет какие-то неточности или несостыковки в документах в самом концу скажи об этом.
            """,
            temperature=0.5,
        )
    )
